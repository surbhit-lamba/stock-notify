// Package logger helps with adding well formatted logging to your application
// Its api compatible with the 'log' package from go standard library,
// and adds utility functions like logrus.Error, logrus.Warn... to make logging easier
package logger

import "go.uber.org/zap"

// Entry wraps the logrus Entry struct
// type Entry struct {
// 	*logrus.Entry
// }

// ErrorLogger returns a development friendly logger useful for debugging
// Function name, File name and Line number fields are appended to
// the error message
// func ErrorLogger() *Entry {
